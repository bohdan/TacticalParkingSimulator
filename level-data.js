export const LEVELS = [
  ...
  },
  {
    ...
    markings: [
      ...
      { type: 'bay', x: 0, y: 3.8, len: 24, ang: 0 },
    ],
  ...
  },
  {
    ...
    solution: [{ steer: 35, dist: -3.65 }, { steer: -35, dist: 0.55 }, { steer: 35, dist: -0.6 }, { steer: -35, dist: 0.6 }, { steer: 35, dist: -0.75 }, { steer: -35, dist: 0.7 }, { steer: 35, dist: -0.5 }, { steer: -35, dist: 0.75 }, { steer: 35, dist: -0.7 }, { steer: -35, dist: 4.75 }],
  },
  {
    id: "q8angu",
    type: "cutscene", name: "Cutscene Tractor",
    message: ["> MSG INCOMING", "TOP SECRET // EYES ONLY // OPERATIVE 008", "", "SUSPECT DR M. T. DEVELOPING", "BIOWEAPONIZED CHICKENS", "", "INFILTRATE NEUTRALIZE", "", "P.S. CONGRATULATIONS ON YOUR NEW", "LAMBORGHINI"],
  },
  {
    id: "ouhmic",
  ...
  {
    id: "cp7s7n",
    name: "Day 2 - Get Out", tier: "Expert", mode: "moves", w: 18, h: 11,
    vehicle: "tractor",
    start: { x: 4.1, y: 5.8, h: Math.PI },
    goal: { cx: 2.6, cy: 1.6, w: 4.4, h: 2.6, heads: [180], tol: 45 },
    walls: [
      { x: 0, y: 3.2, w: 14.1, h: 0.4 },
      { x: 0.4, y: 7.9, w: 7.7, h: 0.4 },
  ...
  {
    id: "rum24d",
    name: "Turn Around", tier: "Hard", mode: "moves", w: 18, h: 11,
    vehicle: "tractor",
  ...
  {
    id: "ph2nks",
    name: "Turn Around Again??", tier: "Hard", mode: "moves", w: 18, h: 11,
    vehicle: "tractor",
    ...
    cars: [],
    hint: "The boss's boss says it should go back in reverse.",
  ...
  },
  {
    ...
    hint: "I'll simply reverse out from now on!",
  ...
  {
    id: "gknchi",
    name: "There's no turning back from here", tier: "Expert", mode: "moves", w: 31, h: 31,
    vehicle: "miata",
    start: { x: 1, y: 2, h: 0 },
    ...
    cars: [
      { cx: 3.1, cy: 4.7, h: 0 },
      { cx: 15.1, cy: 2, h: -2.6643 },
      { cx: 16.6, cy: 9.6, h: -0.6248 },
      { cx: 9.4, cy: 6, h: -1.4050 },
      { cx: 22.8, cy: 6.6, h: -2.4629, type: "bus" },
      { cx: 11.2, cy: 20.8, h: -116 * Math.PI / 180, type: "bus" },
      { cx: 15, cy: 22.6, h: -1.7027, type: "tractor" },
      { cx: 17.57, cy: 12.21, h: 2.4568, type: "tractor" },
      { cx: 24.12, cy: 12.9, h: 0.0750 },
      { cx: 23.4, cy: 20.6, h: 0 },
      { cx: 23.98, cy: 14.9, h: 0 },
    ],
    markings: [
      { type: 'lane', x: 9.6, y: 0, len: 19.3, ang: Math.PI * 2 / 3 },
      { type: 'bay', x: 0.1, y: 11.5, len: 13.29, ang: -Math.PI / 3 },
      { type: 'bay', x: 0.1, y: 20.2, len: 23.31, ang: -Math.PI / 3 },
    ],
    draft: true,
