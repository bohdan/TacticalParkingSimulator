// Web Worker for the parallel brute-force solver. The main thread (solver.ts,
...
onmessage = async (e: MessageEvent) => {
  ...
  const solver = kernel.createSolver();           // binds the kernel inside solver.ts
