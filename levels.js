const LEVELS = [
  ...
  },
  {
    ...
    start: { x: 1.2, y: 3, h: 0 },
    goal: { cx: 12.6, cy: 8.4, w: 5.7, h: 2.3, ang: Math.PI / 6, heads: [30], tol: 15 },
    walls: [
      { x: 0, y: 0, w: 22, h: 1.6, kind: "curb" },
      { x: 0, y: 7.3, w: 5.4, h: 5.7, kind: "curb" },
      { x: 5.4, y: 7.9, w: 3.9, h: 5.1, kind: "curb" },
      { x: 9.3, y: 9.6, w: 1.8, h: 3.4, kind: "curb" },
      { x: 11.1, y: 11.2, w: 3.2, h: 1.8, kind: "curb" },
      { x: 14.3, y: 12.2, w: 0.6, h: 0.8, kind: "curb" },
      { x: 9.3, y: 8.6, w: 0.6, h: 1, kind: "curb" },
      { x: 10, y: 8.9, w: 0.6, h: 0.7, kind: "curb" },
      { x: 11.1, y: 9.9, w: 0.8, h: 1.3, kind: "curb" },
      { x: 11.9, y: 10.1, w: 0.8, h: 1.1, kind: "curb" },
      { x: 12.7, y: 10.5, w: 0.7, h: 0.7, kind: "curb" },
      { x: 13.4, y: 10.9, w: 0.5, h: 0.3, kind: "curb" },
      { x: 14.3, y: 11.7, w: 0.3, h: 0.5, kind: "curb" },
    ],
    cars: [
      { cx: 2.4, cy: 6.1, h: 0 },
      { cx: 7.4, cy: 6.3, h: Math.PI / 12 },
      { cx: 16.5, cy: 12.5, h: Math.PI / 3 },
    ],
    starThresh: [3, 5], starThreshQuick: [17, 26],
    hint: "Part on a curve",
  ...
  },
  {
    ...
    goal: { cx: 15.4, cy: 5.8, w: 5.7, h: 2.3, ang: Math.PI / 6, heads: [-150], tol: 15 },
    walls: [
      { x: 0, y: 0, w: 22, h: 1.6, kind: "curb" },
      { x: 0, y: 7.3, w: 5.4, h: 5.7, kind: "curb" },
      { x: 5.4, y: 7.9, w: 3.9, h: 5.1, kind: "curb" },
      { x: 14.3, y: 11.5, w: 1.9, h: 1.5, kind: "curb" },
