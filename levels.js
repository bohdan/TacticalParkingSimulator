const LEVELS = [
  ...
  },
  {
    ...
    message: ["> MSG INCOMING", "TOP SECRET // EYES ONLY // OPERATIVE 008", "", "FINAL BUDGET REVIEW: COMPLETE.", "", "THE CONVERTIBLE HAS BEEN REPOSSESSED.", "YOUR NEW FIELD ASSET: ONE (1) TRACTOR.", "", "OBJECTIVE: BLEND IN. PARK THE FARM.", "(IT TURNS ON A DIME. ENJOY THAT, AT LEAST.)"],
  },
  {
    id: "ouhmic",
    draft: true,
    name: "Back to the Barn", tier: "Medium", mode: "moves", vehicle: "tractor", w: 18, h: 11,
    start: { x: 14, y: 5.5, h: Math.PI },
    goal: { cx: 3.5, cy: 5.5, w: 5.6, h: 3.4, heads: [180], tol: 45 },
    walls: [
      { x: 0, y: 3.2, w: 7, h: 0.5, kind: "wall" },
      { x: 0, y: 7.8, w: 7, h: 0.5, kind: "wall" },
      { x: 0, y: 3.2, w: 0.5, h: 5.1, kind: "wall" },
    ],
    cars: [],
  ...
  },
  {
    id: "vl8wg1",
    draft: true,
    name: "Around the Bale", tier: "Easy", mode: "moves", vehicle: "tractor", w: 18, h: 11,
    start: { x: 2.5, y: 5.5, h: 0 },
    goal: { cx: 15, cy: 5.5, w: 5.6, h: 3.8, heads: [0], tol: 45 },
    walls: [
      { x: 8.2, y: 3.4, w: 1.8, h: 4.2, kind: "wall" },
    ],
    cars: [],
  ...
  },
  {
    id: "z0h040",
    draft: true,
    name: "Tight Furrow", tier: "Medium", mode: "moves", vehicle: "tractor", w: 20, h: 13,
    start: { x: 3, y: 4, h: 0 },
    goal: { cx: 11, cy: 9.2, w: 5.4, h: 3.4, heads: [0], tol: 45 },
    walls: [
      { x: 0, y: 12, w: 20, h: 1, kind: "curb" },
    ],
    cars: [
      { cx: 4.8, cy: 9.5, h: 0, type: "tractor" },
      { cx: 17.2, cy: 9.5, h: 0, type: "tractor" },
    ],
